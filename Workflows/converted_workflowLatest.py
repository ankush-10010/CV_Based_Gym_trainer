...
def main():
    ...
    with torch.inference_mode():
        ...
        for q in range(10):
            ...
            # <--- PASTE THIS INSTEAD --->
            # Manually get image size (Batch, Height, Width, Channels)
            temp_image = get_value_at_index(loadimage_330, 0)
            
            # Create the list [width, height] that the next node expects
            # Width is shape[2], Height is shape[1]
            getimagesize_428 = [temp_image.shape[2], temp_image.shape[1]]
