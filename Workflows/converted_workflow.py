...
def main():
    ...
    with torch.inference_mode():
        ...
        loadimage = LoadImage()
        loadimage_330 = loadimage.load_image(image="bench.jpeg")
        ...
        downloadandloadsam2model_272 = downloadandloadsam2model.loadmodel(
        ...
        text_prompt_jps_308 = text_prompt_jps.text_prompt(text="Context")

        text_prompt_jps_319 = text_prompt_jps.text_prompt(text="Florence")

        downloadandloadsam2model_335 = downloadandloadsam2model.loadmodel(
        ...
        text_prompt_jps_385 = text_prompt_jps.text_prompt(text="maskedotput")

        text_prompt_jps_400 = text_prompt_jps.text_prompt(text="cannyiameg\n")

        text_prompt_jps_419 = text_prompt_jps.text_prompt(text="Canny_POSE\n")
        ...
        easy_imagescaledown = NODE_CLASS_MAPPINGS["easy imageScaleDown"]()
        ...
        for q in range(10):
            ...
            imageandmaskpreview_233 = imageandmaskpreview.execute(
                mask_opacity=0.7000000000000002,
                mask_color="255, 0, 0",
                pass_through=True,
                mask=get_value_at_index(sam2contextsegmentation_325, 0),
            )

            imageandmaskpreview_238 = imageandmaskpreview.execute(
                mask_opacity=0.5000000000000001,
                mask_color="255, 0, 255",
                pass_through=False,
                image=get_value_at_index(sam2contextsegmentation_325, 2),
                mask=get_value_at_index(sam2contextsegmentation_325, 3),
            )

            image_comparer_rgthree_224 = image_comparer_rgthree.compare_images(
                image_a=get_value_at_index(imageandmaskpreview_233, 0),
                image_b=get_value_at_index(imageandmaskpreview_238, 0),
            )

            cr_text_concatenate_307 = cr_text_concatenate.concat_text(
                separator="_", text2=get_value_at_index(text_prompt_jps_308, 0)
            )

            saveimage_304 = saveimage.save_images(
                filename_prefix=get_value_at_index(cr_text_concatenate_307, 0),
                images=get_value_at_index(imageandmaskpreview_233, 0),
            )
            ...
            maskpreview_327 = maskpreview.execute(
                mask=get_value_at_index(sam2contextsegmentation_325, 3)
            )
            ...
            easy_imagescaledown_404 = easy_imagescaledown.image_scale_down(
                width=1024,
                height=1024,
                crop="center",
                images=get_value_at_index(loadimage_330, 0),
            )

            openposepreprocessor_405 = openposepreprocessor.estimate_pose(
                detect_hand="enable",
                detect_body="enable",
                detect_face="enable",
                resolution=640,
                scale_stick_for_xinsr_cn="disable",
                image=get_value_at_index(easy_imagescaledown_404, 0),
            )
            ...
            getimagesize_428 = getimagesize.EXECUTE_NORMALIZED(
                image=get_value_at_index(loadimage_330, 0),
                unique_id=11320095053713740889,
            )
            ...
            imageresizekjv2_426 = imageresizekjv2.resize(
                ...
                unique_id=13250562400570599869,
            )

            previewbridge_425 = previewbridge.doit(
                image="$53-0",
                block=False,
                restore_mask="never",
                images=get_value_at_index(imageresizekjv2_426, 0),
                unique_id=4233101942034370856,
            )
            ...
            imagecompositemasked_415 = imagecompositemasked.EXECUTE_NORMALIZED(
                ...
                y=0,
                resize_source=False,
                destination=get_value_at_index(previewbridge_425, 0),
